...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Panel de Administración - 4GMovil'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta-description', 'Panel de administración de 4GMovil'); ?>">
    ...
    <?php echo $__env->yieldPushContent('datatables-css'); ?>
...
<body class="bg-gray-100 dark:bg-gray-900">
        ...
        <div x-show="sidebarOpen" class="fixed inset-0 z-50 lg:hidden"
            ...
            <div class="mobile-sidebar" :class="{ 'show': sidebarOpen, 'dark': darkMode }">
                ...
                <div class="flex-1 overflow-y-auto sidebar-nav" style="max-height: calc(100vh - 200px);">
                    <?php echo $__env->make('layouts.partials.sidebar-menu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
                                    ...
                                    <button @click="open = !open"
                                        ...
                                        <?php if(Auth::user()->foto_perfil): ?>
                                            ...
                                            <div
                                                ...
                                                <img class="profile-image lazy-load" src="<?php echo e($photoUrl); ?>"
                                                    alt="<?php echo e(Auth::user()->nombre_usuario); ?>" loading="lazy">
                                            </div>
                                        <?php else: ?>
                                            <div
                                        ...
                                        <?php endif; ?>
                                        <span
                                            class="md:block hidden lg:inline ml-3 text-gray-700 dark:text-cyan-300 font-medium"><?php echo e(Auth::user()->nombre_usuario); ?></span>
                                    </button>
    ...
    <?php echo $__env->yieldPushContent('jquery-script'); ?>

    <!-- Load DataTables only when needed -->
    <?php echo $__env->yieldPushContent('datatables-script'); ?>
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/layouts/app-new.blade.php ENDPATH**/ ?>