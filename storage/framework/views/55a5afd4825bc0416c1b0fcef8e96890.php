                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <a href="<?php echo e(route('pedidos.historial')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Direcciones -->
                        <div class="bg-white rounded-lg shadow p-6">
                            <h2 class="text-xl font-semibold mb-4"><?php echo e(__('profile.my_addresses')); ?></h2>
                            <div class="space-y-4">
                                <?php if($usuario->direcciones->isEmpty()): ?>
                                    <p class="text-gray-500"><?php echo e(__('profile.no_addresses_saved')); ?></p>
                                <?php else: ?>
                                    <?php $__currentLoopData = $usuario->direcciones->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="border-b border-gray-200 pb-3 last:border-b-0 last:pb-0">
                                            ...
                                            <p class="text-gray-900 font-medium"><?php echo e($direccion->nombre_destinatario); ?></p>
                                            <p class="text-gray-900"><?php echo e($direccion->direccion_completa); ?></p>
                                            <p class="text-gray-600 text-sm"><?php echo e($direccion->ciudad); ?>, <?php echo e($direccion->provincia); ?></p>
                                            <p class="text-gray-500 text-xs"><?php echo e($direccion->codigo_postal); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <div class="mt-4">
                                    <a href="<?php echo e(route('direcciones.index')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            ...
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('profile.change_password')); ?></h3>
            ...
            <form id="changePasswordForm" class="space-y-4">
                ...
                <div>
                    <label for="contrasena_actual" class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">
                        <?php echo e(__('profile.current_password')); ?>
                ...
                <div>
                    <label for="nueva_contrasena" class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">
                        <?php echo e(__('profile.new_password')); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/modules/cliente/perfil.blade.php ENDPATH**/ ?>