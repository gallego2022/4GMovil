<?php $__env->startSection('title', 'Crear Método de Pago - 4GMovil'); ?>
...
<div class="space-y-6">
    ...
    <!-- Formulario -->
    <form action="<?php echo e(route('metodos-pago.store')); ?>" method="POST" class="mt-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               <?php echo e(old('estado', true) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\metodos_pago\create.blade.php ENDPATH**/ ?>