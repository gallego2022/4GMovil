<?php $__env->startSection('title', 'Métodos de Pago - 4GMovil'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 sm:hidden" id="mobileCards">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <div class="mb-4">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Métodos de Pago</h2>
                <p class="text-sm text-gray-500 dark:text-gray-300">Gestiona los métodos de pago disponibles</p>
            </div>
            
            <!-- Botones de acción móvil -->
            <div class="flex flex-wrap items-center gap-2 mb-4">
                <!-- Botón Crear Método de Pago -->
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden metodo-card">
            <div class="p-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 flex flex-col space-y-1">
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                ID: <?php echo e($metodo->metodo_id); ?>
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    <a href="<?php echo e(route('metodos-pago.edit', $metodo->metodo_id)); ?>" 
                    ...
                    <form action="<?php echo e(route('metodos-pago.destroy', $metodo->metodo_id)); ?>" method="POST" class="form-eliminar inline">
                        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md">
            ...
            <div class="mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    <div>
                        <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:truncate sm:text-3xl sm:tracking-tight">Métodos de Pago</h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Gestiona los métodos de pago disponibles</p>
                    </div>
            ...
            <!-- Barra de herramientas con búsqueda y filtros (Escritorio) -->
            <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">
                        <span id="infoRegistros">Mostrando todos los métodos de pago</span>
                    </div>
                    ...
                    <table id="tablaMetodos"
                        ...
                        <thead class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 text-gray-700 dark:text-gray-300 text-sm font-semibold">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left font-semibold">Nombre del Método</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 ease-in-out border-b border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($metodo->metodo_id); ?></td>
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($metodo->nombre); ?></td>
...
<style>
    ...
    .dark #tablaMetodos th {
        border-bottom: 1px solid #4b5563 !important;
        border-right: 1px solid #4b5563 !important;
    }
    
    .dark #tablaMetodos td {
        border-bottom: 1px solid #374151 !important;
        border-right: 1px solid #374151 !important;
    }
    
    .dark #tablaMetodos th:last-child,
    .dark #tablaMetodos td:last-child {
        border-right: none !important;
    }
    
    .dark #tablaMetodos tr:last-child td {
    ...
    #tablaMetodos th:last-child,
    #tablaMetodos td:last-child {
        border-right: none !important;
    }
    
    #tablaMetodos tr:last-child td {
        border-bottom: none !important;
    }
...
<script>
    $(document).ready(function() {
        ...
        var hasData = <?php echo e($metodos->count() > 0 ? 'true' : 'false'); ?>;
        
        if (hasData) {
            // Inicializar DataTable solo si hay datos
            var table = $('#tablaMetodos').DataTable({
                dom: 'rtip', // Removido 'f' para ocultar el campo de búsqueda por defecto
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Métodos de Pago - 4GMovil',
             ...
             function updateInfoRegistros() {
                 ...
                 try {
                     ...
                     if (filteredRecords === totalRecords) {
                         $('#infoRegistros').text(`Mostrando ${startRecord} a ${endRecord} de ${totalRecords} métodos de pago`);
                    } else {
                         $('#infoRegistros').text(`Mostrando ${startRecord} a ${endRecord} de ${filteredRecords} métodos de pago (filtrado de ${totalRecords} total)`);
                     }
                 } catch (error) {
            ...
            $('.dataTables_length').hide();
            $('.dataTables_info').hide();
            $('#infoRegistros').text('No hay métodos de pago registrados');
        }
        ...
        function searchMobileCards(searchTerm) {
            ...
            $('#mobileCards .metodo-card').each(function() {
                const card = $(this);
                ...
                if (noResultsMsg.length === 0) {
                    $('#mobileCards').append(`
                        <div id="mobileNoResults" class="text-center py-4 text-sm text-gray-500 dark:text-gray-400">
                            No se encontraron métodos de pago que coincidan con la búsqueda
                        </div>
                    `);
                }
            } else {
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\metodos_pago\index.blade.php ENDPATH**/ ?>