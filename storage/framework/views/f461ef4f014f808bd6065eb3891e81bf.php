    ...
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 p-4">
        ...
        <div class="max-w-xl w-full toggle-forms">
            ...
            <div class="form-container max-w-xl h-auto bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700" id="otp-verification-form">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold text-white">Verificación OTP</h2>
                    <p class="text-gray-400 mt-2">Ingresa el código de 6 dígitos enviado a tu correo</p>
                </div>

                <!-- Formulario de envío de OTP -->
                <div id="sendOtpForm">
                    <div class="text-center mb-6">
                        <h3 class="text-lg font-medium text-white">Enviar Código OTP</h3>
                        <p class="text-sm text-gray-400">Ingresa tu correo electrónico</p>
                    </div>
                    ...
                    <form id="emailForm" class="space-y-4">
                        ...
                        <button type="button" onclick="sendOtp()" id="sendOtpBtn"
                            ...
                            <span id="sendOtpText">Enviar Código OTP</span>
                            <div id="sendOtpSpinner" class="hidden ml-2">
                ...
                <div id="verifyOtpForm" class="hidden">
                    <div class="text-center mb-6">
                        <h3 class="text-lg font-medium text-white">Verificar Código OTP</h3>
                        <p class="text-sm text-gray-400">Código enviado a: <span id="emailDisplay" class="font-medium text-blue-400"></span></p>
                    </div>
                    ...
                    <form id="otpForm" class="space-y-4">
                        ...
                        <button type="button" onclick="backToEmail()" 
                            class="w-full mt-3 flex justify-center py-2 px-4 border border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-300 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                            Cambiar Email
                        </button>
                    </form>
                </div>
...
async function sendOtp() {
    ...
    try {
        ...
        showAlert('Error al enviar el código OTP', 'error');
    } finally {
        // Restaurar botón
        btn.disabled = false;
        text.textContent = 'Enviar Código OTP';
...
function showVerifyForm() {
    document.getElementById('sendOtpForm').classList.add('hidden');
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\auth\otp-verification.blade.php ENDPATH**/ ?>