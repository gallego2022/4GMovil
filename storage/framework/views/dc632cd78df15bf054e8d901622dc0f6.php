...
<?php $__env->startSection('title', 'Checkout Cancelado'); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-8 text-left">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900">#<?php echo e($pedido->pedido_id); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Fecha:</p>
                        <p class="font-medium text-gray-900"><?php echo e($pedido->fecha_pedido->format('d/m/Y H:i')); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Total:</p>
                        <p class="font-medium text-gray-900">$<?php echo e(number_format($pedido->total, 0, ',', '.')); ?></p>
                    </div>
                    <div>
            ...
            <div class="mt-8 text-sm text-gray-500">
                ...
                <p class="mt-2">
                    <a href="<?php echo e(route('contacto.enviar')); ?>" class="text-blue-600 hover:text-blue-800 underline">
                        Contactar Soporte
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\checkout\cancel.blade.php ENDPATH**/ ?>