<?php $__env->startSection('title', 'Crear Marca - 4GMovil'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <!-- Formulario -->
        <form action="<?php echo e(route('marcas.store')); ?>" method="POST" class="mt-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre_marca" id="nombre_marca" value="<?php echo e(old('nombre_marca')); ?>"
                                class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-100 transition-colors duration-200 <?php $__errorArgs = ['nombre_marca'];
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Ej: Apple, Samsung, Xiaomi..." required>
                            <?php $__errorArgs = ['nombre_marca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\pages\admin\marcas\create.blade.php ENDPATH**/ ?>