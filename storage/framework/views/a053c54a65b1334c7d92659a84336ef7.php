            ...
            Gestión de Inventario
             ...
             <div>
                 ...
                 <input type="number" 
                        ...
                        min="0"
                        placeholder="0"
                        class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-100 transition-colors duration-200 <?php $__errorArgs = ['stock_inicial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 dark:border-red-600 text-red-900 dark:text-red-200 placeholder-red-300 dark:placeholder-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
             ...
             <div>
                 ...
                 <input type="number" 
                        ...
                        placeholder="0"
                        disabled
                        class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-400 sm:text-sm cursor-not-allowed transition-colors duration-200 <?php $__errorArgs = ['stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 dark:border-red-600 text-red-900 dark:text-red-200 placeholder-red-300 dark:placeholder-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
             ...
             <div>
                 ...
                 <input type="number" 
                        ...
                        placeholder="0"
                        disabled
                        class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 sm:text-sm cursor-not-allowed transition-colors duration-200 <?php $__errorArgs = ['stock_minimo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 dark:border-red-600 text-red-900 dark:text-red-200 placeholder-red-300 dark:placeholder-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        value="<?php echo e(old('stock_minimo', $producto->stock_minimo ?? 0)); ?>">
                 <p class="mt-1 text-xs text-blue-600 dark:text-blue-400">
                     <span class="font-medium">Se calcula automáticamente:</span> 20% del stock inicial
                     <?php if(isset($producto) && $producto->stock > 0): ?>
                         <br><span class="text-gray-500">Ejemplo: Stock inicial <?php echo e($producto->stock); ?> → Umbral crítico <?php echo e(ceil($producto->stock * 0.2)); ?></span>
                     <?php endif; ?>
                 </p>
...
unset($__errorArgs, $__bag); ?>
             ...
             <div>
                 ...
                 <input type="number" 
                        ...
                        placeholder="0"
                        disabled
                        class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-300 sm:text-sm cursor-not-allowed transition-colors duration-200 <?php $__errorArgs = ['stock_maximo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 dark:border-red-600 text-red-900 dark:text-red-200 placeholder-red-300 dark:placeholder-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        value="<?php echo e(old('stock_maximo', $producto->stock_maximo ?? 0)); ?>">
                 <p class="mt-1 text-xs text-yellow-600 dark:text-yellow-400">
                     ...
                     <?php if(isset($producto) && $producto->stock > 0): ?>
                         <br><span class="text-gray-500">Ejemplo: Stock inicial <?php echo e($producto->stock); ?> → Umbral bajo <?php echo e(ceil($producto->stock * 0.6)); ?></span>
                     <?php endif; ?>
                 </p>
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/pages/admin/productos/form.blade.php ENDPATH**/ ?>