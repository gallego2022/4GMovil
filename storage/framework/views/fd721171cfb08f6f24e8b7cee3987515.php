            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2"><?php echo e(__('messages.nav.contact')); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#contacto"
                    ...
                    <i class="fas fa-paper-plane mr-2"></i><?php echo e(__('messages.contact.send_message')); ?>
                ...
                <a href="#ubicacion"
                    ...
                    <i class="fas fa-map-marker-alt mr-2"></i><?php echo e(__('messages.contact.view_location')); ?>
    ...
    <section class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6"><?php echo e(__('messages.contact.multiple_ways')); ?></h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    <?php echo e(__('messages.contact.choose_option')); ?>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold mb-4"><?php echo e(__('messages.contact.call_us')); ?></h3>
                    ...
                    <a href="tel:+573025970220"
                        ...
                        <i class="fas fa-phone mr-2"></i><?php echo e(__('messages.contact.call_now')); ?>
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold mb-4"><?php echo e(__('messages.contact.write_us')); ?></h3>
                    ...
                    <a href="mailto:osmandavidgallego@gmail.com?subject=Consulta%204GMovil&body=Hola%20equipo%20de%204GMovil,%0A%0AMe%20gustaría%20obtener%20más%20información%20sobre%20sus%20productos%20y%20servicios.%0A%0ASaludos,%0A"
                        class="inline-block mt-4 bg-white bg-opacity-20 px-4 py-2 rounded-lg hover:bg-opacity-30 transition-all duration-300">
                        <i class="fas fa-envelope mr-2"></i><?php echo e(__('messages.contact.send_email')); ?>
    ...
    <section id="contacto" class="py-20 bg-gray-50 dark:bg-gray-800">
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6"><?php echo e(__('messages.contact.send_us_message')); ?></h2>
                    <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        <?php echo e(__('messages.contact.complete_form')); ?>
                    ...
                    <div
                        ...
                        <form id="contactForm" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label for="nombre"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.name')); ?>
                                    ...
                                    <input type="text" id="nombre" name="nombre" required
                                        ...
                                        placeholder="<?php echo e(__('messages.contact.your_full_name')); ?>">
                                </div>
                                <div>
                                    <label for="apellido"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.lastname')); ?>

                                        *</label>
                                    <input type="text" id="apellido" name="apellido" required
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
                                        placeholder="<?php echo e(__('messages.contact.your_lastname')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label for="email"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.email')); ?>

                                        *</label>
                                    <input type="email" id="email" name="email" required
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
                                        placeholder="<?php echo e(__('messages.contact.your_email')); ?>">
                                </div>
                                <div>
                                    <label for="telefono"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.phone')); ?>

                                        *</label>
                                    <input type="tel" id="telefono" name="telefono" required
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
                                        placeholder="<?php echo e(__('messages.contact.your_phone')); ?>">
                                </div>
                            </div>

                            <div>
                                <label for="asunto"
                                    class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.subject')); ?>

                                    *</label>
                                <select id="asunto" name="asunto" required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white dark:bg-gray-600 text-gray-900 dark:text-white">
                                    <option value=""><?php echo e(__('messages.contact.select_subject')); ?></option>
                                    <option value="consulta-producto"><?php echo e(__('messages.contact.product_inquiry')); ?></option>
                                    <option value="servicio-tecnico"><?php echo e(__('messages.contact.technical_service')); ?></option>
                                    <option value="venta-corporativa"><?php echo e(__('messages.contact.corporate_sales')); ?></option>
                                    <option value="soporte"><?php echo e(__('messages.contact.support')); ?></option>
                                    <option value="otro"><?php echo e(__('messages.contact.other')); ?></option>
                                </select>
                            </div>

                            <div>
                                <label for="mensaje"
                                    class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('messages.contact.message')); ?>
                                ...
                                <textarea id="mensaje" name="mensaje" rows="5" required
                                    ...
                                    placeholder="<?php echo e(__('messages.contact.tell_us_help')); ?>"></textarea>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="terminos" class="ml-2 text-sm text-gray-600 dark:text-gray-300">
                                    <?php echo e(__('messages.contact.accept_terms')); ?> <a href="#"
                                        class="text-blue-600 dark:text-blue-400 hover:underline"><?php echo e(__('messages.contact.terms_conditions')); ?></a>
                                    *
                                </label>
                            </div>
                            ...
                            <button type="submit"
                                ...
                                <?php echo e(__('messages.contact.send_message')); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ACER\Documents\GitHub\4GMovil\resources\views/pages/landing/contactanos.blade.php ENDPATH**/ ?>