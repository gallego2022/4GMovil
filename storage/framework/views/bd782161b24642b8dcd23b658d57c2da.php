<?php $__env->startSection('title', 'Administración de Pedidos - 4GMovil'); ?>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden pedido-card">
            <div class="p-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 flex flex-col space-y-1">
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Cliente: <?php echo e($pedido->usuario->nombre_usuario); ?>

                            </p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Email: <?php echo e($pedido->usuario->correo_electronico); ?>

                            </p>
                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                Total: $<?php echo e(number_format($pedido->detalles->sum(function($detalle) { return $detalle->cantidad * $detalle->precio_unitario; }), 0, ',', '.')); ?>

                            </p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Fecha: <?php echo e(\Carbon\Carbon::parse($pedido->fecha_pedido)->format('d/m/Y H:i')); ?>

                            </p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Método: <?php echo e(\App\Helpers\PaymentHelper::getPaymentMethodName($pedido)); ?>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                ?>
                                <span class="inline-flex items-center rounded-md <?php echo e($estadoClasses['bg']); ?> px-2 py-1 text-xs font-medium <?php echo e($estadoClasses['text']); ?> ring-1 ring-inset <?php echo e($estadoClasses['ring']); ?>">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    <a href="<?php echo e(route('admin.pedidos.show', $pedido->pedido_id)); ?>" 
                ...
                <table id="tablaPedidos"
                    ...
                    <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            <td class="px-4 py-2">#<?php echo e($pedido->pedido_id); ?></td>
                            <td class="px-4 py-2">
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-gray-100">
                                        <?php echo e($pedido->usuario->nombre_usuario); ?>

                                    </div>
                                    <div class="text-gray-500 dark:text-gray-400">
                                        <?php echo e($pedido->usuario->correo_electronico); ?>
                            ...
                            <td class="px-4 py-2">
                                <div>
                                    <div class="text-gray-900 dark:text-gray-100">
                                        <?php echo e(\Carbon\Carbon::parse($pedido->fecha_pedido)->format('d/m/Y')); ?>

                                    </div>
                                    <div class="text-gray-500 dark:text-gray-400">
                                        <?php echo e(\Carbon\Carbon::parse($pedido->fecha_pedido)->format('H:i')); ?>
                            ...
                            <td class="px-4 py-2"><?php echo e(\App\Helpers\PaymentHelper::getPaymentMethodName($pedido)); ?></td>
...
<script>
    $(document).ready(function() {
        ...
        var hasData = <?php echo e($pedidos->count() > 0 ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/pages/admin/pedidos/index.blade.php ENDPATH**/ ?>