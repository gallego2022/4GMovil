<?php $__env->startSection('title', 'Servicio Técnico - 4G Móvil'); ?>
<?php $__env->startSection('meta_description', 'Servicio técnico profesional para celulares, tablets y computadoras. Reparaciones con garantía, diagnóstico gratuito y repuestos originales en Medellín.'); ?>
...
<div class="container mx-auto px-4 py-3 bg-gray-100 dark:bg-gray-800">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2"><?php echo e(__('messages.nav.technical_service')); ?></span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="container mx-auto px-4 py-20 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                <div class="inline-flex items-center px-4 py-2 bg-white bg-opacity-20 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
                    ...
                    <?php echo e(__('messages.technical_service.title')); ?>

                </div>
                
                <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                    <?php echo e(__('messages.technical_service.subtitle')); ?>

                </h1>
                
                <p class="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
                    <?php echo e(__('messages.technical_service.description')); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#servicios"
                        ...
                        <i class="fas fa-tools mr-2"></i><?php echo e(__('messages.technical_service.view_services')); ?>
                    ...
                    <a href="#diagnostico"
                        ...
                        <i class="fas fa-stethoscope mr-2"></i><?php echo e(__('messages.technical_service.free_diagnosis')); ?>
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <span class="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-sm font-medium mb-4">
                    <i class="fas fa-star mr-2"></i><?php echo e(__('messages.technical_service.specialized_services')); ?>

                </span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                    <?php echo e(__('messages.technical_service.integral_solutions')); ?>

                </h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    <?php echo e(__('messages.technical_service.certified_technicians')); ?>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e(__('messages.technical_service.free_diagnosis_title')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.technical_service.free_diagnosis_desc')); ?>
                ...
                <div class="group bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e(__('messages.technical_service.fast_repairs')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.technical_service.fast_repairs_desc')); ?>
                ...
                <div class="group bg-gradient-to-br from-purple-50 to-violet-100 dark:from-purple-900/20 dark:to-violet-900/20 rounded-xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e(__('messages.technical_service.software_system')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.technical_service.software_system_desc')); ?>
                ...
                <div class="group bg-gradient-to-br from-orange-50 to-red-100 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e(__('messages.technical_service.total_warranty')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.technical_service.total_warranty_desc')); ?>
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                    <?php echo e(__('messages.technical_service.repair_all_devices')); ?>

                </h2>
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    <?php echo e(__('messages.technical_service.repair_all_devices_desc')); ?>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e(__('messages.technical_service.smartphones')); ?></h3>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e(__('messages.technical_service.tablets')); ?></h3>
                        <ul class="text-gray-600 dark:text-gray-300 space-y-2 text-left">
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-2"></i>
                                Pantallas táctiles
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e(__('messages.technical_service.computers')); ?></h3>
                        <ul class="text-gray-600 dark:text-gray-300 space-y-2 text-left">
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-2"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (serviceForm) {
        serviceForm.addEventListener('submit', function(e) {
            ...
            // Enviar formulario
            fetch('<?php echo e(route("servicio-tecnico.enviar")); ?>', {
                method: 'POST',
                headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ACER\Documents\GitHub\4GMovil\resources\views/pages/landing/servicio-tecnico.blade.php ENDPATH**/ ?>