                ...
                <div class="overflow-x-auto">
                    <table id="tablaProductos"
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <td class="px-6 py-4 text-gray-700 dark:text-gray-300"><?php echo e($producto->categoria->nombre_categoria ?? 'Sin categoría'); ?></td>
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyecto V11.3\4GMovil\resources\views/pages/admin/productos/listadoP.blade.php ENDPATH**/ ?>