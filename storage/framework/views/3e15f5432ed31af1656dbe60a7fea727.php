                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-700 rounded-xl p-3 sm:p-4">
                            ...
                            <div class="flex justify-between text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2">
                                <span>Mín: $<?php echo e(number_format($precioMinimo, 0, ',', '.')); ?></span>
                                <span>Máx: $<?php echo e(number_format($precioMaximo, 0, ',', '.')); ?></span>
                            </div>
                            <div class="text-center">
                                <span class="text-sm sm:text-lg font-bold text-blue-600 dark:text-blue-400">
                                    Precio máximo: <span
                                        id="maxPrice">$<?php echo e(number_format($precioMaximo, 0, ',', '.')); ?></span>
                                </span>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
    ...
    <script>
                ...
                switch (tipo) {
                    ...
                    case 'precio':
                        ...
                        if (priceRange) {
                            ...
                            const maxPrice = document.getElementById('maxPrice');
                            if (maxPrice) {
                                maxPrice.textContent = '$<?php echo e(number_format($precioMaximo, 0, ',', '.')); ?>';
                            }
                        }
        ...
        function debugDatabaseState() {
            ...
            console.log('Productos originales de Blade:', <?php echo e($productos->count()); ?>);
            console.log('Total de productos:', <?php echo e($productos->total()); ?>);
            console.log('Página actual:', <?php echo e($productos->currentPage()); ?>);
            console.log('Última página:', <?php echo e($productos->lastPage()); ?>);
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/pages/landing/productos.blade.php ENDPATH**/ ?>