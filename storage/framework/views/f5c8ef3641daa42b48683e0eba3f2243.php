<?php $__env->startSection('title', 'Exportar Reporte de Inventario - 4GMovil'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-lg font-semibold text-blue-900 dark:text-blue-100"><?php echo e($reporte['resumen_general']['total_productos'] ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-lg font-semibold text-green-900 dark:text-green-100">$<?php echo e(number_format($reporte['resumen_general']['valor_total_inventario'] ?? 0, 2)); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-lg font-semibold text-yellow-900 dark:text-yellow-100"><?php echo e($reporte['resumen_general']['productos_stock_bajo'] ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-lg font-semibold text-red-900 dark:text-red-100"><?php echo e($reporte['resumen_general']['productos_sin_stock'] ?? 0); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php if(isset($reporte['alertas']) && !empty($reporte['alertas'])): ?>
        <div class="mb-6">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                            <ul class="list-disc list-inside space-y-1">
                                <?php $__currentLoopData = $reporte['alertas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- Valor por categoría -->
        <?php if(isset($reporte['valor_por_categoria']) && !empty($reporte['valor_por_categoria'])): ?>
        <div class="mb-6">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                <?php echo e($item['stock_total'] ?? 0); ?>
                                 ...
                                 $<?php echo e(number_format($item['valor_total'], 2)); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#exportPDF').on('click', function() {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.inventario.exportar-pdf")); ?>',
                method: 'POST',
                data: {
                    secciones: secciones,
        ...
        $('#exportExcel').on('click', function() {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.inventario.exportar-excel")); ?>',
                method: 'POST',
                data: {
                    secciones: secciones,
                    _token: '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\pages\admin\inventario\exportar-reporte.blade.php ENDPATH**/ ?>