                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-400"><?php echo e($producto->categoria->nombre_categoria ?? 'No especificado'); ?></span>
                                </div>
                                <div class="flex justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $producto->resenas->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resena): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div
                            ...
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    <?php echo e(\Carbon\Carbon::parse($resena->fecha_creacion)->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyecto V11.3\4GMovil\resources\views/productos/show.blade.php ENDPATH**/ ?>