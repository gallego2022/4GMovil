...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style_inicio.css')); ?>">
...
<body class="bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <nav class="bg-white dark:bg-gray-800 sticky top-0 z-50 shadow-sm transition-colors duration-300" x-data="{ mobileMenuOpen: false }">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('landing')); ?>" class="text-2xl font-bold text-blue-600">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="relative group" x-data="{ open: false }" @keydown.escape.window="open = false">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="block">
                                <?php echo csrf_field(); ?>
                                <button type="button"
            ...
            <div class="px-4 py-6 space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <form id="logout-form-mobile" action="<?php echo e(route('logout')); ?>" method="POST" class="block">
                            <?php echo csrf_field(); ?>
                            <button type="button"
            ...
            <div class="container mx-auto px-4 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <div class="lg:col-span-1">
                        <div class="flex items-center mb-6">
                            <img src="<?php echo e(asset('img/Logo_2.png')); ?>" alt="4GMovil" class="h-10 mr-3">
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">4GMovil</h3>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            <?php echo e(__('messages.footer.about_us')); ?>
                    ...
                    <div>
                        <h3 class="text-xl font-bold mb-6 text-gray-900 dark:text-white flex items-center">
                            ...
                            <?php echo e(__('messages.footer.quick_links')); ?>

                        </h3>
                        <ul class="space-y-3">
                            <li>
                                <a href="<?php echo e(route('landing')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group">
                                    ...
                                    <?php echo e(__('messages.footer.home')); ?>

                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('productos.lista')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group">
                                    <i class="fas fa-chevron-right mr-2 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform duration-300"></i>
                                    <?php echo e(__('messages.footer.products')); ?>
                            ...
                            <li>
                                <a href="#" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group">
                                    <i class="fas fa-chevron-right mr-2 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform duration-300"></i>
                                    <?php echo e(__('messages.footer.services')); ?>

                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('nosotros')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group">
                                    <i class="fas fa-chevron-right mr-2 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform duration-300"></i>
                            ...
                            <li>
                                <a href="<?php echo e(route('contactanos')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group">
                                    <i class="fas fa-chevron-right mr-2 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform duration-300"></i>
                                    <?php echo e(__('messages.footer.contact')); ?>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-gray-600 dark:text-gray-300">
                            <li class="flex items-start group">
                                ...
                                <div>
                                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e(__('messages.footer.address')); ?></span>
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo __('messages.footer.address_value'); ?></p>
                                </div>
                            </li>
                            <li class="flex items-start group">
                                ...
                                <div>
                                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e(__('messages.footer.phone')); ?></span>
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e(__('messages.footer.phone_value')); ?></p>
                                </div>
                            </li>
                            <li class="flex items-start group">
                                ...
                                <div>
                                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e(__('messages.footer.email')); ?></span>
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e(__('messages.footer.email_value')); ?></p>
                                </div>
                            </li>
                            <li class="flex items-start group">
                                ...
                                <div>
                                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e(__('messages.footer.hours')); ?></span>
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo __('messages.footer.hours_value'); ?></p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/10">
                        <div class="flex items-center mb-4">
                            ...
                            <h4 class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(__('messages.footer.official_warranty')); ?></h4>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('messages.footer.official_warranty_desc')); ?></p>
                    </div>
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/10">
                        <div class="flex items-center mb-4">
                            ...
                            <h4 class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(__('messages.footer.free_shipping')); ?></h4>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('messages.footer.free_shipping_desc')); ?></p>
                    </div>
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/10">
                        <div class="flex items-center mb-4">
                            ...
                            <h4 class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(__('messages.footer.support_24_7')); ?></h4>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('messages.footer.support_24_7_desc')); ?></p>
                    </div>
                </div>
                ...
                <div class="pt-8 text-center">
                    <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div class="flex items-center">
                            <img src="<?php echo e(asset('img/Logo_2.png')); ?>" alt="Logo 4GMovil" class="h-10 mr-3">
                            <div>
                                <p class="text-gray-900 dark:text-white font-bold">© 2025 4GMovil</p>
                                <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('messages.footer.all_rights_reserved')); ?></p>
                            </div>
                        </div>
                        <div class="flex space-x-6 text-sm text-gray-500 dark:text-gray-400">
                            <a href="#" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-300"><?php echo e(__('messages.footer.privacy_policy')); ?></a>
                            <a href="#" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-300"><?php echo e(__('messages.footer.terms_of_service')); ?></a>
                            <a href="#" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-300"><?php echo e(__('messages.footer.cookie_policy')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-4xl max-h-[98vh] sm:max-h-[95vh] overflow-hidden transition-all duration-500 transform scale-95 opacity-0"
                    ...
                    <div class="flex flex-col lg:flex-row h-[calc(98vh-120px)] sm:h-[calc(95vh-140px)]">
                        ...
                        <div
                            ...
                            <!-- Botón de checkout -->
                            <form id="checkout-form" action="<?php echo e(route('checkout.index')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
    ...
    <?php echo $__env->make('layouts.partials.sweet-alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        ...
        if (googlePasswordForm) {
            googlePasswordForm.addEventListener('submit', function(e) {
                ...
                fetch('<?php echo e(route('google.set-password')); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(Auth::check() && !Auth::user()->contrasena && Auth::user()->rol === 'cliente'): ?>
...
<?php /**PATH C:\Users\ACER\Documents\GitHub\4GMovil\resources\views/layouts/landing.blade.php ENDPATH**/ ?>