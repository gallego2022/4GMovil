...
<nav class="space-y-2">
    ...
    <!-- Categorías -->
    <div x-data="{ open: <?php echo e(request()->routeIs('categorias.*') || request()->routeIs('admin.especificaciones.*') ? 'true' : 'false'); ?> }">
        <button @click="open = !open" 
                class="sidebar-nav-item w-full text-left <?php echo e(request()->routeIs('categorias.*') || request()->routeIs('admin.especificaciones.*') ? 'active' : ''); ?>">
            <svg class="mr-3 flex-shrink-0 h-5 w-5" 
                 fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-show="open" class="sidebar-submenu mt-1">
            ...
            <a href="<?php echo e(route('admin.especificaciones.index')); ?>" 
               class="sidebar-submenu-item <?php echo e(request()->routeIs('admin.especificaciones.*') ? 'active' : ''); ?>">
    ...
    <!-- Inventario -->
    <div x-data="{ open: <?php echo e(request()->routeIs('admin.inventario.*') ? 'true' : 'false'); ?> }">
        <button @click="open = !open" 
                class="sidebar-nav-item w-full text-left <?php echo e(request()->routeIs('admin.inventario.*') ? 'active' : ''); ?>">
            <svg class="mr-3 flex-shrink-0 h-5 w-5" 
                 fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
            </svg>
        ...
        <div x-show="open" class="sidebar-submenu mt-1">
            <a href="<?php echo e(route('admin.inventario.dashboard')); ?>" 
               class="sidebar-submenu-item <?php echo e(request()->routeIs('admin.inventario.dashboard') ? 'active' : ''); ?>">
                <span>Dashboard</span>
            </a>
            <a href="<?php echo e(route('admin.inventario.reporte')); ?>" 
               class="sidebar-submenu-item <?php echo e(request()->routeIs('admin.inventario.reporte') ? 'active' : ''); ?>">
                <span>Reporte</span>
            </a>
            <a href="<?php echo e(route('admin.inventario.movimientos')); ?>" 
               class="sidebar-submenu-item <?php echo e(request()->routeIs('admin.inventario.movimientos') ? 'active' : ''); ?>">
                <span>Movimientos</span>
            </a>
            <a href="<?php echo e(route('admin.inventario.alertas')); ?>" 
               class="sidebar-submenu-item <?php echo e(request()->routeIs('admin.inventario.alertas') ? 'active' : ''); ?>">
                <span>Alertas</span>
            </a>
        </div>
    </div>
</nav>
<?php /**PATH C:\Users\usuario\Documents\GitHub\4GMovil\resources\views/layouts/partials/sidebar-menu.blade.php ENDPATH**/ ?>