...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/loading-animations.css')); ?>">
    <style>
        [x-cloak] {
    ...
    <nav class="bg-white dark:bg-gray-800 sticky top-0 z-50 shadow-sm transition-colors duration-300" x-data="{ mobileMenuOpen: false }">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="<?php echo e(route('landing')); ?> " data-loading-message="Cargando inicio..."
                ...
                <a href="<?php echo e(route('productos.lista')); ?>" data-loading-message="Cargando productos..."
                ...
                <a href="<?php echo e(route('servicios')); ?>" data-loading-message="Cargando servicio tecnico..."
                ...
                <a href="<?php echo e(route('nosotros')); ?>" data-loading-message="Cargando nosotros..."
                ...
                <a href="<?php echo e(route('contactanos')); ?>" data-loading-message="Cargando contacto..."
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="relative group" x-data="{ open: false }" @keydown.escape.window="open = false">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <a href="<?php echo e(route('perfil')); ?>" data-loading-message="Cargando perfil..."
                            ...
                            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="block" data-loading-message="Cerrando sesión...">
                                <?php echo csrf_field(); ?>
                                <button type="button"
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" data-loading-message="Cargando login..."
            ...
            <div class="px-4 py-6 space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <form id="logout-form-mobile" action="<?php echo e(route('logout')); ?>" method="POST" class="block" data-loading-message="Cerrando sesión...">
                            <?php echo csrf_field(); ?>
                            <button type="button"
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/layouts/landing.blade.php ENDPATH**/ ?>