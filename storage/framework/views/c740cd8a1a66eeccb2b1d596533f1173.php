        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2"><?php echo e(__('messages.nav.about_us')); ?></span>
                </div>
            </li>
        </ol>
    </nav>
...
<section class="min-h-[60vh] flex items-center relative overflow-hidden pt-16 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p class="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-8 text-blue-100 leading-relaxed max-w-3xl mx-auto px-4">
            <?php echo e(__('messages.about.subtitle')); ?>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#historia" class="bg-white text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
                <i class="fas fa-history mr-2"></i><?php echo e(__('messages.about.know_our_history')); ?>
            ...
            <a href="#equipo" class="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-100 hover:text-blue-600 transition-all duration-300 transform hover:scale-105">
                <i class="fas fa-users mr-2"></i><?php echo e(__('messages.about.our_team')); ?>
...
<section id="historia" class="py-20 bg-white dark:bg-gray-900">
    <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6"><?php echo e(__('messages.about.our_history')); ?></h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                    <?php echo e(__('messages.about.history_desc')); ?>
                ...
                <div class="grid grid-cols-2 gap-6 mt-8">
                    <div class="text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6">
                        ...
                        <div class="text-gray-600 dark:text-gray-300"><?php echo e(__('messages.about.years_experience')); ?></div>
                    </div>
                    <div class="text-center bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6">
                        ...
                        <div class="text-gray-600 dark:text-gray-300"><?php echo e(__('messages.about.satisfied_clients')); ?></div>
                    </div>
                </div>
            </div>
            <div class="relative">
                <div class="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white shadow-xl transform hover:scale-105 transition-all duration-300">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold mb-4"><?php echo e(__('messages.about.constant_growth')); ?></h3>
                        <p class="text-lg opacity-90 leading-relaxed">
                            <?php echo e(__('messages.about.growth_desc')); ?>
...
<section class="py-20 bg-gray-50 dark:bg-gray-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6"><?php echo e(__('messages.about.our_values')); ?></h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                <?php echo e(__('messages.about.values_desc')); ?>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-600">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4"><?php echo e(__('messages.about.trust')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.about.trust_desc')); ?>
            ...
            <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-600">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4"><?php echo e(__('messages.about.innovation')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.about.innovation_desc')); ?>
            ...
            <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-600">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4"><?php echo e(__('messages.about.passion')); ?></h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        <?php echo e(__('messages.about.passion_desc')); ?>
...
<section class="py-20 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold mb-6"><?php echo e(__('messages.about.our_numbers')); ?></h2>
            <p class="text-xl opacity-90">
                <?php echo e(__('messages.about.numbers_desc')); ?>
        ...
        <div class="grid md:grid-cols-4 gap-8">
            <div class="text-center bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm hover:bg-opacity-20 transition-all duration-300">
                ...
                <div class="text-lg opacity-90"><?php echo e(__('messages.about.satisfied_clients')); ?></div>
            </div>
            <div class="text-center bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm hover:bg-opacity-20 transition-all duration-300">
                <div class="text-4xl md:text-5xl font-bold mb-2 counter" data-target="50000">0</div>
                <div class="text-lg opacity-90"><?php echo e(__('messages.about.devices_sold')); ?></div>
            </div>
            <div class="text-center bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm hover:bg-opacity-20 transition-all duration-300">
                <div class="text-4xl md:text-5xl font-bold mb-2 counter" data-target="25">0</div>
                <div class="text-lg opacity-90"><?php echo e(__('messages.about.stores_colombia')); ?></div>
            </div>
            <div class="text-center bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm hover:bg-opacity-20 transition-all duration-300">
                <div class="text-4xl md:text-5xl font-bold mb-2 counter" data-target="98">0</div>
                <div class="text-lg opacity-90"><?php echo e(__('messages.about.satisfaction_rate')); ?></div>
            </div>
        </div>
    </div>
</section>
...
<section id="equipo" class="py-20 bg-white dark:bg-gray-900">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-6"><?php echo e(__('messages.about.our_team')); ?></h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                <?php echo e(__('messages.about.team_desc')); ?>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center group">
                ...
                <p class="text-blue-600 dark:text-blue-400 font-semibold mb-4"><?php echo e(__('messages.about.ceo_founder')); ?></p>
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                    <?php echo e(__('messages.about.ceo_desc')); ?>
            ...
            <div class="text-center group">
                ...
                <p class="text-green-600 dark:text-green-400 font-semibold mb-4"><?php echo e(__('messages.about.operations_director')); ?></p>
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                    <?php echo e(__('messages.about.operations_director_desc')); ?>
            ...
            <div class="text-center group">
                ...
                <p class="text-purple-600 dark:text-purple-400 font-semibold mb-4"><?php echo e(__('messages.about.technical_director')); ?></p>
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                    <?php echo e(__('messages.about.technical_director_desc')); ?>
...
<section class="py-20 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white">
    <div class="container mx-auto px-4 text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-6"><?php echo e(__('messages.about.ready_connect_future')); ?></h2>
        <p class="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            <?php echo e(__('messages.about.join_thousands')); ?>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('productos.lista')); ?>" class="bg-white text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
                <i class="fas fa-shopping-cart mr-2"></i><?php echo e(__('messages.about.view_products')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ACER\Documents\GitHub\4GMovil\resources\views/pages/landing/nosotros.blade.php ENDPATH**/ ?>