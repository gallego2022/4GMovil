                    ...
                    <table id="tablaCategorias"
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 ease-in-out border-b border-gray-100 dark:border-gray-800">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($categoria->nombre_categoria); ?></td>
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\pages\admin\categorias\index.blade.php ENDPATH**/ ?>