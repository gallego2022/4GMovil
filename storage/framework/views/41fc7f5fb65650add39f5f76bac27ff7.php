                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2 relative rounded-md shadow-sm">
                                <input type="text" name="nombre_marca" id="nombre_marca"
                                    value="<?php echo e(old('nombre_marca', $marca->nombre_marca)); ?>"
                                    class="block w-full px-4 py-3 rounded-md border-0 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-brand-600 dark:focus:ring-brand-500 dark:bg-gray-800 sm:text-sm sm:leading-6 transition-colors duration-200 <?php $__errorArgs = ['nombre_marca'];
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\pages\admin\marcas\edit.blade.php ENDPATH**/ ?>