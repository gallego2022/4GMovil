<?php $__env->startSection('title', 'Crear Categoría - 4GMovil'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <!-- Formulario -->
        <form action="<?php echo e(route('categorias.store')); ?>" method="POST" class="mt-6">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre_categoria" id="nombre_categoria"
                                value="<?php echo e(old('nombre_categoria')); ?>"
                                class="block w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-100 transition-colors duration-200 <?php $__errorArgs = ['nombre_categoria'];
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\pages\admin\categorias\create.blade.php ENDPATH**/ ?>