                ...
                <?php if(session('email_sent')): ?>
                    <div class="mt-6 p-4 bg-blue-900 bg-opacity-30 rounded-lg border border-blue-800">
                        <p class="text-blue-200 text-sm">
                            <strong>Código enviado a:</strong> <?php echo e(session('email_sent')); ?>
                        ...
                        <div class="mt-3">
                            <form method="POST" action="<?php echo e(route('password.reset.otp.post')); ?>" class="inline">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="email" value="<?php echo e(session('email_sent')); ?>">
                                <button type="submit" 
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\auth\passwords\email-otp.blade.php ENDPATH**/ ?>