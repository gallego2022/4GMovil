...
<body>
    <div class="container">
        ...
        <div class="stock-info">
            ...
            <p><strong>Stock Actual:</strong> <span class="stock-number"><?php echo e($producto->stock); ?></span> unidades</p>
            <p><strong>Porcentaje del Stock:</strong> <span class="stock-number"><?php echo e($porcentajeActual); ?>%</span></p>
            <p><strong>Stock Mínimo:</strong> <?php echo e($stockMinimo); ?> unidades</p>
            <p><strong>Estado:</strong> <span style="color: #dc3545;">CRÍTICO</span></p>
        </div>
        
        <div class="product-details">
            <h3>📦 Detalles del Producto</h3>
            <p><strong>Nombre:</strong> <?php echo e($producto->nombre_producto); ?></p>
            <p><strong>Código:</strong> <?php echo e($producto->codigo ?? 'N/A'); ?></p>
            <p><strong>Categoría:</strong> <?php echo e($producto->categoria->nombre_categoria ?? 'N/A'); ?></p>
            <p><strong>Precio:</strong> $<?php echo e(number_format($producto->precio, 0, ',', '.')); ?></p>
            <p><strong>Fecha de Alerta:</strong> <?php echo e(now()->format('d/m/Y H:i')); ?></p>
        </div>
...
<?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views\correo\stock-bajo.blade.php ENDPATH**/ ?>