    ...
    <div class="grid grid-cols-1 gap-4 sm:hidden" id="mobileCards">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-300">Gestiona las especificaciones técnicas de cada categoría</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden especificacion-card">
            <div class="p-4">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    ...
                    <form action="<?php echo e(route('admin.especificaciones.destroy', $especificacion->especificacion_id)); ?>" method="POST" class="form-eliminar inline">
                        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md">
            ...
            <div class="mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    <div>
                        <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:truncate sm:text-3xl sm:tracking-tight">Especificaciones por Categoría</h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Gestiona las especificaciones técnicas de cada categoría</p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div class="overflow-x-auto">
                    <table id="tablaEspecificaciones"
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 ease-in-out border-b border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($especificacion->especificacion_id); ?></td>
                                                                 <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($especificacion->etiqueta); ?></td>
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e($especificacion->categoria->nombre ?? 'Sin categoría'); ?></td>
                                                                 <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100"><?php echo e(ucfirst($especificacion->tipo_campo)); ?></td>
                                           ...
                                           class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/50 dark:hover:bg-blue-900 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-all duration-200 ease-in-out transform hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M15.232 5.232l3.536 3.536M9 13l6-6m-3-3L6 18H3v-3L15.232 5.232z" />
                                            </svg>
                                        </a>
                                        <div
...
<script>
    Swal.fire({
        title: 'Eliminado',
        text: 'La especificación ha sido eliminada correctamente.',
        icon: 'success',
        timer: 2000,
        showConfirmButton: false
    });
    ...
    $(document).ready(function() {
             ...
             function updateInfoRegistros() {
                 ...
                 try {
                     ...
                     if (filteredRecords === totalRecords) {
                         $('#infoRegistros').text(`Mostrando ${startRecord} a ${endRecord} de ${totalRecords} especificaciones`);
                    } else {
                         $('#infoRegistros').text(`Mostrando ${startRecord} a ${endRecord} de ${filteredRecords} especificaciones (filtrado de ${totalRecords} total)`);
                     }
                 } catch (error) {
        ...
        function searchMobileCards(searchTerm) {
            ...
            $('#mobileCards .especificacion-card').each(function() {
                ...
                const matchFound = nombre.includes(searchTerm) || categoria.includes(searchTerm) || tipo.includes(searchTerm);
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osman\OneDrive\Documentos\GitHub\4GMovil\resources\views/pages/admin/especificaciones/index.blade.php ENDPATH**/ ?>