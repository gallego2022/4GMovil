                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <?php if($totalResenas > 0): ?>
                            <span class="text-gray-500 text-sm ml-2 font-medium">
                                (<?php echo e($totalResenas); ?> <?php echo e($totalResenas == 1 ? __('messages.products.review') : __('messages.products.reviews')); ?>)
                            </span>
                        <?php else: ?>
                            <span class="text-gray-400 text-sm ml-2 font-medium">
                                (<?php echo e(__('messages.products.no_reviews')); ?>)
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="flex justify-between items-center mb-4">
                    <div>
                        ...
                        ?>
                        <span
                            class="font-black text-2xl text-blue-600"><?php echo e(\App\Helpers\CurrencyHelper::formatPrice($precio)); ?></span>
                    </div>
                    <?php if($showShipping): ?>
        ...
        <div class="px-4 pb-4">
            ...
            <?php if($stockDisponible > 0): ?>
                <?php if($tieneVariantes): ?>
                    ...
                    <button type="button"
                        ...
                        <?php echo e(__('messages.products.select_variant')); ?>
                ...
                <?php else: ?>
                    ...
                    <button type="button"
                        ...
                        <?php echo e(__('messages.products.add_to_cart')); ?>
            ...
            <?php else: ?>
                <button type="button"
                    ...
                    <?php echo e(__('messages.products.out_of_stock')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ACER\Documents\GitHub\4GMovil\resources\views/components/product-card.blade.php ENDPATH**/ ?>