<?php $__env->startSection('title', 'Mi Perfil - 4GMovil'); ?>
<?php $__env->startSection('meta-description', 'Gestiona tu perfil de usuario en 4GMovil'); ?>
        ...
        <div class="bg-white dark:bg-gray-900 shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8">
                <div class="flex items-center">
                    ...
                    <div class="ml-6">
                        <h1 class="text-2xl font-bold text-white"><?php echo e($usuario->nombre_usuario); ?></h1>
                        <p class="text-blue-200"><?php echo e($usuario->correo_electronico); ?></p>
                        <p class="text-blue-200 mt-1">
                            <i class="fas fa-phone-alt mr-2"></i><?php echo e($usuario->telefono ?? 'No especificado'); ?>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <form action="<?php echo e(route('perfil.actualizar')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
                            ...
                            <a href="<?php echo e(route('pedidos.historial')); ?>" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                                </svg>
                                <?php echo e(__('profile.view_order_history')); ?>
                        ...
                        <!-- Direcciones -->
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
                            <h2 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white"><?php echo e(__('profile.my_addresses')); ?></h2>
                            <div class="space-y-4">
                                <?php if($usuario->direcciones->isEmpty()): ?>
                                    <p class="text-gray-500 dark:text-gray-400"><?php echo e(__('profile.no_addresses_saved')); ?></p>
                                <?php else: ?>
                                    <?php $__currentLoopData = $usuario->direcciones->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="border-b border-gray-200 dark:border-gray-700 pb-3 last:border-b-0 last:pb-0">
                                            <div class="flex items-center justify-between mb-2">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($direccion->tipo_direccion === 'casa' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : ($direccion->tipo_direccion === 'apartamento' ? 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' : 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200')); ?>">
                                            ...
                                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($direccion->nombre_destinatario); ?></p>
                                            <p class="text-gray-900 dark:text-white"><?php echo e($direccion->direccion_completa); ?></p>
                                            <p class="text-gray-600 dark:text-gray-400 text-sm"><?php echo e($direccion->ciudad); ?>, <?php echo e($direccion->provincia); ?></p>
                                            <p class="text-gray-500 dark:text-gray-500 text-xs"><?php echo e($direccion->codigo_postal); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <div class="mt-4">
                                    <a href="<?php echo e(route('direcciones.index')); ?>" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        </svg>
                                        <?php echo e($usuario->direcciones->isEmpty() ? 'Agregar dirección' : 'Gestionar direcciones'); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\usuario\Documents\GitHub\4GMovil\resources\views/modules/cliente/perfil.blade.php ENDPATH**/ ?>