<?php $__env->startSection('title', 'Editar Especificación - 4GMovil'); ?>
...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Modifica la especificación técnica: <span class="font-medium text-brand-600 dark:text-brand-400"><?php echo e($especificacion->etiqueta); ?></span>
        </p>
        <div class="mt-2 flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
            <span>Categoría: <span class="font-medium"><?php echo e($especificacion->categoria->nombre ?? 'Sin categoría'); ?></span></span>
            <span>Campo: <span class="font-mono bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded"><?php echo e($especificacion->nombre_campo); ?></span></span>
            <span>Tipo: <span class="font-medium"><?php echo e(ucfirst($especificacion->tipo_campo)); ?></span></span>
        </div>
    </div>

    <!-- Formulario -->
    <div class="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 dark:ring-gray-800/5 sm:rounded-xl md:col-span-2">
        <form action="<?php echo e(route('admin.especificaciones.update', $especificacion->especificacion_id)); ?>" method="POST" class="px-4 py-6 sm:p-8">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select id="categoria_id" name="categoria_id" required
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($categoria->categoria_id); ?>" <?php echo e(old('categoria_id', $especificacion->categoria_id) == $categoria->categoria_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" id="orden" name="orden" value="<?php echo e(old('orden', $especificacion->orden)); ?>" min="0"
                               class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nombre_campo" name="nombre_campo" value="<?php echo e(old('nombre_campo', $especificacion->nombre_campo)); ?>" required
                               class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="etiqueta" name="etiqueta" value="<?php echo e(old('etiqueta', $especificacion->etiqueta)); ?>" required
                               class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <select id="tipo_campo" name="tipo_campo" required
                            ...
                            <option value="text" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'text' ? 'selected' : ''); ?>>Texto</option>
                            <option value="textarea" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'textarea' ? 'selected' : ''); ?>>Área de texto</option>
                            <option value="number" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'number' ? 'selected' : ''); ?>>Número</option>
                            <option value="select" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'select' ? 'selected' : ''); ?>>Selector</option>
                            <option value="checkbox" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'checkbox' ? 'selected' : ''); ?>>Casilla de verificación</option>
                            <option value="radio" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'radio' ? 'selected' : ''); ?>>Botones de radio</option>
                            <option value="date" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'date' ? 'selected' : ''); ?>>Fecha</option>
                            <option value="email" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'email' ? 'selected' : ''); ?>>Email</option>
                            <option value="url" <?php echo e(old('tipo_campo', $especificacion->tipo_campo) == 'url' ? 'selected' : ''); ?>>URL</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="unidad" name="unidad" value="<?php echo e(old('unidad', $especificacion->unidad)); ?>"
                               class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="opciones_container" class="mt-6 <?php echo e(in_array($especificacion->tipo_campo, ['select', 'radio', 'checkbox']) ? 'block' : 'hidden'); ?>">
                    ...
                    <textarea id="opciones" name="opciones" rows="3"
                              class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
                              placeholder="Ingresa las opciones separadas por comas (ej: 2GB, 4GB, 8GB, 16GB)"><?php echo e(old('opciones', $especificacion->opciones)); ?></textarea>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="requerido" name="requerido" value="1" <?php echo e(old('requerido', $especificacion->requerido) ? 'checked' : ''); ?>
                    ...
                    <!-- Activo -->
                    <div class="flex items-center">
                        <input type="checkbox" id="activo" name="activo" value="1" <?php echo e(old('activo', $especificacion->activo) ? 'checked' : ''); ?>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="3"
                              class="block w-full px-4 py-3 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-brand-500 focus:ring-brand-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm transition-colors duration-200"
                              placeholder="Descripción opcional del campo"><?php echo e(old('descripcion', $especificacion->descripcion)); ?></textarea>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                    <div>
                        ...
                        <span class="ml-2 text-gray-900 dark:text-gray-100 font-mono"><?php echo e($especificacion->especificacion_id); ?></span>
                    </div>
                    <div>
                        <span class="font-medium text-gray-700 dark:text-gray-300">Creado:</span>
                        <span class="ml-2 text-gray-900 dark:text-gray-100"><?php echo e($especificacion->created_at ? $especificacion->created_at->format('d/m/Y H:i') : 'N/A'); ?></span>
                    </div>
                    <div>
                        <span class="font-medium text-gray-700 dark:text-gray-300">Última actualización:</span>
                        <span class="ml-2 text-gray-900 dark:text-gray-100"><?php echo e($especificacion->updated_at ? $especificacion->updated_at->format('d/m/Y H:i') : 'N/A'); ?></span>
                    </div>
                </div>
            </div>
...
<form id="form-eliminar" action="<?php echo e(route('admin.especificaciones.destroy', $especificacion->especificacion_id)); ?>" method="POST" class="hidden">
    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        const tipo = tipoCampoSelect.value;
        const etiqueta = document.getElementById('etiqueta').value || '<?php echo e($especificacion->etiqueta); ?>';
        const unidad = document.getElementById('unidad').value || '<?php echo e($especificacion->unidad); ?>';
        const opciones = document.getElementById('opciones').value || '<?php echo e($especificacion->opciones); ?>';
...
function confirmarEliminacion() {
    Swal.fire({
        title: '¿Estás seguro?',
        text: "Esta acción no se puede deshacer. Se eliminará la especificación: <?php echo e($especificacion->etiqueta); ?>",
        icon: 'warning',
...
<?php echo $__env->make('layouts.app-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\usuario\Documents\GitHub\4GMovil\resources\views/pages/admin/especificaciones/edit.blade.php ENDPATH**/ ?>