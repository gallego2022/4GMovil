            ...
            <form action="{{ route('direcciones.store') }}" method="POST" class="space-y-6" id="direccionForm">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="complemento" 
                           id="complemento" 
                           class="mt-2 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="tel" 
                               name="telefono" 
                               id="telefono" 
                               class="flex-1 rounded-none rounded-r-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                               required
                               pattern="[0-9]{10}"
                               maxlength="10"
