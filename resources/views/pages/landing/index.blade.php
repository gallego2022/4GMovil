...
@section('content')
    ...
    <section id="inicio"
        class="min-h-screen flex items-center relative pt-16 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-black"
        style="overflow: visible;">
        <!-- Partículas decorativas de fondo -->
        <div class="absolute inset-0 pointer-events-none" style="z-index: 1; overflow: visible;">
            <div class="hero-particle hero-particle-1 absolute top-20 left-10 w-80 h-80 rounded-full"
                style="background: rgba(59, 130, 246, 0.6); filter: blur(40px);"></div>
            <div class="hero-particle hero-particle-2 absolute bottom-20 right-10 w-80 h-80 rounded-full"
                style="background: rgba(99, 102, 241, 0.6); filter: blur(40px);"></div>
            <div class="hero-particle hero-particle-3 absolute top-1/3 left-1/2 -translate-x-1/2 w-72 h-72 rounded-full"
                style="background: rgba(147, 51, 234, 0.55); filter: blur(40px);"></div>
            <div class="hero-particle hero-particle-4 absolute bottom-1/3 left-20 w-72 h-72 rounded-full"
                style="background: rgba(236, 72, 153, 0.55); filter: blur(40px);"></div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style="z-index: 10;">
            <div class="grid lg:grid-cols-12 gap-6 items-center">
                ...
                <div id="hero_container" class="lg:col-span-11 text-gray-900 dark:text-white group">
                    <div
                        class="hero-fade-in hero-fade-in-1 inline-flex items-center px-3 py-1 rounded-full bg-gray-900/5 dark:bg-white/10 border border-gray-900/10 dark:border-white backdrop-blur mb-5 motion-safe:animate-pulse group-hover:[animation-play-state:paused]">
                        <span class="text-sm">{{ __('landing.hero.badge') }}</span>
                    </div>
                    <h1
                        class="hero-fade-in hero-fade-in-2 text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight">
                        <span class="sr-only">Tecnología a tu alcance</span>
                        <div class="relative">
                            <svg class="block w-full max-w-none h-auto" viewBox="0 0 1600 260" aria-hidden="true"
                                preserveAspectRatio="xMinYMid meet" style="overflow: visible;">
                                <defs>
                                    <linearGradient id="heroTitleGradient" x1="0%" y1="0%" x2="100%"
                                        y2="0%">
                                ...
                                <text x="0" y="180" fill="transparent" stroke="url(#heroTitleGradient)" stroke-width="4"
                                    stroke-linejoin="round" font-weight="800"
                                    font-family="'Manrope', 'Inter', 'Segoe UI', ui-sans-serif, system-ui, -apple-system, Roboto, Helvetica, Arial, Noto Sans, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'"
                                    style="letter-spacing:-0.02em; font-size:132px; filter: url(#glow);"
                    ...
                    <p
                        class="hero-fade-in hero-fade-in-3 mt-5 text-lg sm:text-xl text-gray-700 dark:text-gray-100/90 max-w-4xl">
                        <span
                            id="hero_subtitle_text">{{ __('landing.hero.phrases')[0] ?? 'Encuentra los mejores productos y servicios de tecnología a tu alcance.' }}</span>
                        <span class="inline-block w-3 align-baseline ml-0.5 bg-gray-700 dark:bg-gray-100 animate-pulse"
                        ...
                        if (particles.length > 0) {
                            particles.forEach(function(particle, idx) {
                                requestAnimationFrame(function() {
                                    ...
                                    console.log('Animación de partícula activada:', idx, particle
                                        .className);
                                });
                            });
                        } else {
