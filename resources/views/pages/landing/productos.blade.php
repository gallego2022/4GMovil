...
<div class="container mx-auto px-4 py-3 bg-gray-100 dark:bg-gray-800">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-700 rounded-xl p-3 sm:p-4">
                            <div class="mb-3">
                                <input type="range" min="{{ $precioMinimo }}" max="{{ $precioMaximo }}"
                                    value="{{ $precioMaximo }}" step="10000" class="w-full price-range accent-blue-500"
                                    id="priceRange">
                            </div>
                        ...
                        <div class="mt-6 text-center">
                            <div
                                ...
                                <span class="text-sm text-blue-800 dark:text-blue-300 font-medium">
                                    Mostrando {{ $productos->firstItem() ?? 0 }} a {{ $productos->lastItem() ?? 0 }} de
    ...
    <script>
        ...
        function getCurrentFilters() {
            ...
            const priceRange = document.getElementById('priceRange');
            const precioMaximo = {{ $precioMaximo }};
