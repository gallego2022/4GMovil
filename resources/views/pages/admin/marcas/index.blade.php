...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Gestiona las marcas de los productos</p>
        </div>
        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg dark:ring-white dark:ring-opacity-10">
                    <table id="tablaMarcas" class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('marcas.edit', $marca) }}" 
                                           class="inline-flex items-center rounded-md bg-white dark:bg-gray-800 px-2.5 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            Editar
                                        </a>
                                        <form action="{{ route('marcas.destroy', $marca) }}" method="POST" class="form-eliminar inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="inline-flex items-center rounded-md bg-red-50 dark:bg-red-950 px-2.5 py-1.5 text-sm font-semibold text-red-700 dark:text-red-400 shadow-sm ring-1 ring-inset ring-red-600/20 dark:ring-red-900/20 hover:bg-red-100 dark:hover:bg-red-900">
                                                Eliminar
                                            </button>
                                        </form>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tablaMarcas').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                $('.paginate_button').addClass('relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 dark:text-gray-200 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 focus:z-20 focus:outline-offset-0');
                $('.paginate_button.current').addClass('z-10 bg-brand-600 text-white dark:text-white hover:bg-brand-500 ring-brand-600').removeClass('text-gray-900 ring-gray-300');
                $('.paginate_button.disabled').addClass('opacity-50 cursor-not-allowed');

                // Aplicar estilos dark mode a elementos de DataTables
                $('.dataTables_length select').addClass('dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700');
                $('.dataTables_filter input').addClass('dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700');
                $('.dataTables_info').addClass('dark:text-gray-200');
            }
        });
