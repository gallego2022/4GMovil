        ...
        <form action="{{ route('admin.especificaciones.store') }}" method="POST" class="px-4 py-6 sm:p-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-validation-field 
                        ...
                        help-text="Categoría para la cual se define la especificación"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-validation-field 
                        ...
                        :required="true"
                        :rules="['required', 'minLength:2', 'maxLength:50', 'uniqueFieldName', 'fieldNameFormat']"
                        :messages="[
                            'required' => 'El nombre del campo es requerido',
                            'minLength' => 'Mínimo 2 caracteres',
                            'maxLength' => 'Máximo 50 caracteres',
                            'uniqueFieldName' => 'Este nombre ya existe en esta categoría',
                            'fieldNameFormat' => 'Solo letras minúsculas, números y guiones bajos'
                        ]"
                    ...
                    <x-validation-field 
                        ...
                        :required="true"
                        :rules="['required', 'minLength:2', 'maxLength:100', 'labelFormat']"
                        :messages="[
                            'required' => 'La etiqueta es requerida',
                            'minLength' => 'Mínimo 2 caracteres',
                            'maxLength' => 'Máximo 100 caracteres',
                            'labelFormat' => 'Debe empezar con mayúscula'
                        ]"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                ...
                <div id="field_preview" class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md p-4">
                    <p class="text-gray-500 dark:text-gray-400 text-center">Selecciona un tipo de campo para ver la vista previa</p>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        const tipo = tipoCampoSelect.value;
        const etiqueta = document.getElementById('etiqueta').value || 'Etiqueta';
