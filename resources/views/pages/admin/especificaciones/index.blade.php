        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden especificacion-card">
            <div class="p-4">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    ...
                    <form action="{{ route('admin.especificaciones.destroy', $especificacion->especificacion_id) }}" method="POST" class="form-eliminar inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
                    ...
                    <table id="tablaEspecificaciones"
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 ease-in-out border-b border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ $especificacion->especificacion_id }}</td>
                                                                 <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ $especificacion->etiqueta }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ $especificacion->categoria->nombre ?? 'Sin categoría' }}</td>
                                                                 <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ ucfirst($especificacion->tipo_campo) }}</td>
