...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <!-- Botón Ver Especificación -->
                <a href="{{ route('admin.especificaciones.show', $especificacion->especificacion_id) }}" 
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden">
        <form action="{{ route('admin.especificaciones.update', $especificacion->especificacion_id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div id="opciones_container" class="mt-6 options-input {{ in_array($especificacion->tipo_campo, ['select', 'radio', 'checkbox']) ? 'show' : '' }}">
