...
@section('title', __('admin.fields.category') . ' - 4GMovil')
    ...
    <div class="space-y-6">
        ...
        <div>
            <h2
                ...
                Nueva {{ __('admin.fields.category') }}
            </h2>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <x-validation-field 
                            ...
                            :required="true"
                            :rules="['required', 'minLength:2', 'maxLength:100', 'noNumbers', 'noSpecialChars']"
                            :messages="[
                            ...
                            help-text="Nombre descriptivo de la categoría (solo letras y espacios)"
                        />
                    </div>
                </div>
            </div>
