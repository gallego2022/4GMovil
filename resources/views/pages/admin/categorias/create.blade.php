...
@section('title', '__('admin.actions.create') __('admin.fields.category') - 4GMovil')
    ...
    <div class="space-y-6">
        ...
        <div>
            <h2
                ...
                __('admin.actions.create') Nueva __('admin.fields.category')</h2>
        ...
        <form action="{{ route('categorias.store') }}" method="POST" class="mt-6">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                        ...
                        __('admin.messages.info') de la __('admin.fields.category')
                    </h3>

                    <div class="grid grid-cols-1 gap-6">
                        <!-- __('admin.status.no')mbre de la categoría -->
                        <div>
                            <label for="nombre"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                __('admin.status.no')mbre de la __('admin.fields.category') <span class="text-red-500">*</span>
                            </label>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit"
                    ...
                    __('admin.actions.save') __('admin.fields.category')
                </button>
            </div>
        </form>
    </div>
