    ...
    <div class="grid grid-cols-1 gap-4 sm:hidden" id="mobileCards">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
            ...
            <div class="flex flex-wrap items-center gap-2 mb-4">
                <!-- Botón{{  }}{{ __('admin.fields.category') }} -->
            ...
            <div class="relative mt-2 rounded-md shadow-sm">
                <input type="text" 
                       ...
                       placeholder={{ "{{ __('admin.actions.search') }} }}categorías...">
        ...
        <div class="text-center py-4 text-sm text-gray-500 dark:text-gray-400">
           {{  }}hay categorías registradas en el sistema
        </div>
        @endforelse
    </div>
...
@push('styles')
<style>
    /*{{  }}completamente los botones por defecto de DataTables */
    .dt-buttons {
    ...
    /*{{  }}elementos de DataTables que no necesitamos */
    .dataTables_filter {
        display: none !important;
    }
...
<script>
    $(document).ready(function() {
        ...
        var hasData = {{ $categorias->count() > 0 ? 'true' : 'false' }};
        ...
        if (hasData) {
                ...
                drawCallback: function(settings) {
                 ...
                 initComplete: function(settings, json) {
                     ...
                     if (this.api().data().length === 0) {
                         //{{  }}elementos de DataTables cuando no hay datos
            ...
            $('.dataTables_length').hide();
            $('.dataTables_info').hide();
            $('#infoRegistros').text({{ '{{ __('admin.status.no') }} }}hay categorías registradas');
        }
                ...
                if (noResultsMsg.length === 0) {
                    $('#mobileCards').append(`
                        <div id="mobileNoResults" class="text-center py-4 text-sm text-gray-500 dark:text-gray-400">
                           {{  }}se encontraron categorías que coincidan con la búsqueda
                        </div>
                    `);
                }
            } else {
