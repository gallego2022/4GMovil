                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="space-y-4 mb-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-900">{{ $detalle->producto->nombre_producto }}</h3>
                                        <p class="text-sm text-gray-500">Cantidad: {{ $detalle->cantidad }}</p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm font-medium text-gray-900">${{ number_format($detalle->precio_unitario, 0, ',', '.') }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-4 space-y-2">
                                <div class="flex justify-between text-lg font-semibold">
                                    ...
                                    <span class="text-gray-900">${{ number_format($pedido->total, 0, ',', '.') }}</span>
                                </div>
                            </div>
                        </div>
