    ...
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="w-full lg:w-2/3 px-4 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                @if(session('mensaje'))
                    <div class="mb-4 rounded-md p-4 {{ session('tipo', 'success') === 'success' ? 'bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-200' : 'bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-200' }}">
                        <div class="flex">
                        ...
                        @if($direcciones->isEmpty())
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-6 mb-4 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('direcciones.create') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 dark:focus:ring-offset-gray-800 transition-colors">
                        ...
                        @else
                            <div class="space-y-4">
                                @foreach($direcciones as $direccion)
                                    <div class="border border-gray-200 dark:border-gray-600 rounded p-4 hover:border-blue-500 dark:hover:border-blue-400 transition-colors {{ old('direccion_id') == $direccion->direccion_id ? 'border-blue-500 dark:border-blue-400' : '' }}">
                                        <label class="flex items-start cursor-pointer">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">{{ $direccion->nombre_destinatario }}</h4>
                                                <p class="text-gray-600 dark:text-gray-400 mb-1">{{ $direccion->telefono }}</p>
                                                ...
                                                <p class="text-gray-600 dark:text-gray-400">{{ $direccion->ciudad }}, {{ $direccion->provincia }}</p>
                                                <p class="text-gray-600 dark:text-gray-400">{{ $direccion->pais }} - Código Postal: {{ $direccion->codigo_postal }}</p>
                                                @if($direccion->referencias)
                                                    <div class="mt-2 p-2 bg-gray-50 dark:bg-gray-700 rounded text-sm">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400">{{ $direccion->referencias }}</p>
                                                    </div>
                                                @endif
                                            </div>
                                        </label>
                            ...
                            <div class="mt-4 text-center">
                                <a href="{{ route('direcciones.create') }}" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium transition-colors">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                    </svg>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 sticky top-4">
                    ...
                    @foreach($cart as $item)
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400">Cantidad: {{ $item['quantity'] }}</p>
                            </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-600 pt-4">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white">${{ number_format($total, 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="flex justify-between items-center text-lg font-bold">
                        ...
                        <span class="text-primary dark:text-blue-400">${{ number_format($total, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
        </div>
