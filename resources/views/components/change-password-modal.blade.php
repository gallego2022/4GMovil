    ...
    <div class="relative top-20 mx-auto p-6 border w-96 shadow-2xl rounded-2xl bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600">
        <div class="mt-3">
            ...
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{ $title ?? 'Cambiar Contraseña' }}</h3>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" 
                               ...
                               required 
                               class="mt-1 block w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500"
                               placeholder="{{ $newPasswordPlaceholder ?? 'Mínimo 8 caracteres' }}">
                        <button type="button" 
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" 
                               ...
                               required 
                               class="mt-1 block w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500"
                               placeholder="{{ $confirmPasswordPlaceholder ?? 'Repite tu nueva contraseña' }}">
                        <button type="button" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const route = '{{ $submitRoute ?? route("cambiar.contrasena.post") }}';
            ...
            submitButton.textContent = '{{ $submitButtonText ?? "Cambiar Contraseña" }}';
        }
    });
});
</script>
