...
@section('title', 'Métodos de Pago - 4GMovil')
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden metodo-card">
            <div class="p-4">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    ...
                    <form action="{{ route('metodos-pago.destroy', $metodo->metodo_id) }}" method="POST" class="form-eliminar inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
                    ...
                    <table id="tablaMetodos"
                        ...
                        <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 ease-in-out border-b border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ $metodo->metodo_id }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-100">{{ $metodo->nombre }}</td>
...
<script>
    $(document).ready(function() {
        ...
        var hasData = {{ $metodos->count() > 0 ? 'true' : 'false' }};
