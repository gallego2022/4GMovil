...
@section('title', 'Editar Método de Pago - 4GMovil')
...
<div class="space-y-6">
    ...
    <!-- Formulario -->
    <form action="{{ route('metodos-pago.update', $metodo->metodo_id) }}" method="POST" class="mt-6">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" 
                               ...
                               {{ old('estado', $metodo->estado ?? true) ? 'checked' : '' }}>
