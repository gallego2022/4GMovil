    ...
    <div class="container">
        ...
        <div class="product-info">
            ...
            <div class="variant-info">
                <div class="color-preview" style="background-color: {{ $variante->codigo_color ?? '#CCCCCC' }};"></div>
                <div class="variant-details">
                    <div class="variant-name">{{ $variante->nombre }}</div>
                    <div style="color: #6c757d; font-size: 14px;">
                        Código: {{ $variante->variante_id }} | 
                        Precio adicional: ${{ number_format($variante->precio_adicional, 0, ',', '.') }}
                    </div>
                </div>
            </div>
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value">{{ $producto->producto_id }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Variante ID</div>
                <div class="info-value">{{ $variante->variante_id }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Categoría</div>
                <div class="info-value">{{ $producto->categoria->nombre ?? 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Marca</div>
                <div class="info-value">{{ $producto->marca->nombre ?? 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Precio Base</div>
                <div class="info-value">${{ number_format($producto->precio, 0, ',', '.') }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Precio Total</div>
                <div class="info-value">${{ number_format($producto->precio + $variante->precio_adicional, 0, ',', '.') }}</div>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p>Fecha de agotamiento: {{ $fechaAgotamiento }}</p>
