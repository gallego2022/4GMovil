    ...
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 p-4">
        ...
        <div class="max-w-xl w-full toggle-forms">
            ...
            <div class="form-container max-w-xl h-auto bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700" id="reset-password-form">
                ...
                <form method="POST" action="{{ route('password.update') }}" id="password-form" class="space-y-6">
                    @csrf
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <input type="email" 
                                   ...
                                   required
                                   class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition @error('email') border-red-500 @enderror"
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <input type="text" 
                                   ...
                                   maxlength="6"
                                   required 
                                   class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition text-center text-lg font-mono tracking-widest @error('otp_code') border-red-500 @enderror"
                                   placeholder="000000">
                            <div class="input-highlight"></div>
                        </div>
                        @error('otp_code')
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <input type="password" 
                                   ...
                                   name="password"
                                   required
                                   class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition pr-10 @error('password') border-red-500 @enderror"
