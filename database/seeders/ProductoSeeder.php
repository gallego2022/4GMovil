...
class ProductoSeeder extends Seeder
{
    ...
    private function crearProductosSmartphones($categoria, $marcas)
    {
        ...
        foreach ($productos as $producto) {
            ...
            $this->crearProductoConUmbrales($producto);
        }
    ...
    /**
     * Crea un producto con los umbrales de stock calculados automáticamente
     */
    private function crearProductoConUmbrales(array $datos): Producto
    {
        $stockInicial = $datos['stock_inicial'];
        
        // Calcular umbrales basados en stock_inicial
        ...
        $producto = Producto::create([
            ...
            'stock_minimo' => $umbralCritico, // Umbral crítico (20%)
            'stock_maximo' => $umbralBajo, // Umbral bajo (60%)
            'estado' => $datos['estado'],
            'activo' => $datos['activo'],
