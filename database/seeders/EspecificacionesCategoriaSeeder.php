...
class EspecificacionesCategoriaSeeder extends Seeder
{
    ...
    {
        // Primero necesitamos crear algunas categorías básicas
        $categorias = [
            ['nombre_categoria' => 'Smartphones'],
            ['nombre_categoria' => 'Laptops'],
            ['nombre_categoria' => 'Tablets'],
            ['nombre_categoria' => 'Auriculares'],
            ['nombre_categoria' => 'Bafles'],
            ['nombre_categoria' => 'Smartwatches'],
        ...
        $smartphones = DB::table('categorias')->where('nombre_categoria', 'Smartphones')->first();
        $laptops = DB::table('categorias')->where('nombre_categoria', 'Laptops')->first();
        $tablets = DB::table('categorias')->where('nombre_categoria', 'Tablets')->first();
        $auriculares = DB::table('categorias')->where('nombre_categoria', 'Auriculares')->first();
        $bafles = DB::table('categorias')->where('nombre_categoria', 'Bafles')->first();
        $smartwatches = DB::table('categorias')->where('nombre_categoria', 'Smartwatches')->first();
    ...
    private function crearEspecificacionesTablets($categoriaId)
    {
        $especificaciones = [
            ...
            ['nombre_campo' => 'procesador', 'etiqueta' => 'Procesador', 'tipo_campo' => 'text', 'requerido' => true, 'orden' => 5],
            ['nombre_campo' => 'bateria', 'etiqueta' => 'Capacidad de Batería', 'tipo_campo' => 'number', 'unidad' => 'mAh', 'requerido' => true, 'orden' => 6],
            ['nombre_campo' => 'camara_principal', 'etiqueta' => 'Cámara Principal', 'tipo_campo' => 'text', 'unidad' => 'MP', 'requerido' => false, 'orden' => 7],
            ['nombre_campo' => 'camara_frontal', 'etiqueta' => 'Cámara Frontal', 'tipo_campo' => 'text', 'unidad' => 'MP', 'requerido' => false, 'orden' => 8],
